...
/**
 * \file    test/phpunit/DoliSupportFunctionalTest.php
 * \ingroup dolisupport
...
/**
 * Class DoliSupportFunctionalTest
 *
 ...
 *
 * @package Testdolisupport
 */
class DoliSupportFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modDoliSupport')->click();
		} else {
			// Disable the module
			$this->byHref('modDoliSupport')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/dolisupport/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('dolisupport/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/dolisupport/admin/about.php');
		$this->authenticate();
		return $this->assertContains('dolisupport/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('dolisupportwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modDoliSupport_DoliSupportTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modDoliSupport_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
